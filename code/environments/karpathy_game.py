"""Code from https://github.com/nivwusquorum/tensorflow-deepq/blob/master/tf_rl/simulation/karpathy_game.py"""
...
##TODO (MUST) This game (abstract) class needs to be revised such that it is compatable with openai gym class.
