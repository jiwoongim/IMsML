import os, sys, math, time, inspect, zipfile, urllib, re, itertools
...
def prepare_data(seqs_x, seqs_y, maxlen=None, n_words_src=30000,
    ...
    maxlen_x = maxlen #np.max(lengths_x) + 1 #This will give tight bound
    maxlen_y = maxlen #np.max(lengths_y) + 1 #This will give tight bound
